...
bool nombrePremier(int number) { //fonction vérif nbPremier
  if (number <= 1) {
    return false;
  }
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 1;
  List<int> listFruit = []; //liste de fruits

  String typeDeNombre(int valeurFruit) { //détermine si nb premier, pair ou impair
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final backgroundColor = siPair ? Colors.indigo : Colors.cyan; //backgroundcolor en fonction de pair ou impair

          final imageVerif = premierPairImpair //image affichée en fonction du type de nb
              ? Image.asset(
                  'images/ananas.png',
                  width: 40,
                  height: 40, 
